...
class SettingWindow(QWidget):
    ...
    def settingApplyAndSave(self):
        ...
        self.windowsManager.dataManager.saveAllSettings(self.topicSettingText.text(), (pushintervalstart, pushintervalend))

        self.hide()

    def settingLoad(self, topic, intervalStart, intervalEnd):
        self.topicSettingText.setText(topic)

        self.pushIntervalStart.setText(str(intervalStart))
        self.pushIntervalEnd.setText(str(intervalEnd))
